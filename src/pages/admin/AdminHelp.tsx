    ...
    const sections: Section[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { id: 'ai_settings', label: "4. Systémová nastavení AI modelů", description: "Funkce:\nV sekci Faktury na záložce 'Nastavení AI' si můžete zvolit preferovaný AI model (OpenAI, Gemini nebo Anthropic) pro automatické čtení a zpracování PDF faktur.\n\nBezpečnost:\nAPI klíče jsou vkládány přes bezpečný formulář a do databáze se ukládají zašifrovaně pomocí rozšíření pgcrypto. Nikdy neopouští zabezpečené jádro a komunikují výhradně s izolovanými Edge Funkcemi na pozadí." }
            ]
        }
    ];
