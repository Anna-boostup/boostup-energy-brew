        ...
        <div className="space-y-8">
            ...
            <Tabs defaultValue="pending" className="w-full">
                <div className="overflow-x-auto overflow-y-hidden whitespace-nowrap scrollbar-hide pb-4 -mx-4 px-4 md:overflow-visible md:pb-0 md:mx-0 md:px-0 mb-8 sm:mb-12">
                    <TabsList className="inline-flex w-max md:flex md:w-full md:grid md:grid-cols-6 bg-admin-canvas/60 backdrop-blur-md p-2 sm:p-3 rounded-[2.5rem] h-auto border border-white/20 shadow-xl shadow-olive/5">
