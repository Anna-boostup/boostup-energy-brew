    ...
    return (
        <LegalLayout title="Ochrana osobních údajů" lastUpdated="19. února 2026" seoTitle="Ochrana osobních údajů | BoostUp Energy">
            <div className="prose prose-invert max-w-none">
                ...
                <p>
                    Správcem osobních údajů je společnost <strong>BOOSTUP SUPPLEMENTS S.R.O.</strong>, se sídlem Lidická 700/19, Brno, IČO: 24045560 (dále jen „správce“). Kontaktní e-mail: <a href="mailto:info@drinkboostup.cz">info@drinkboostup.cz</a>, pro administrativní a účetní dotazy <a href="mailto:fakturace@drinkboostup.cz">fakturace@drinkboostup.cz</a>.
                </p>
