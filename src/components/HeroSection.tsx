    ...
    <section className="min-h-screen pt-20 relative overflow-hidden" style={{ backgroundColor: '#f4f1e6' }}>
      <div className="container mx-auto px-4 pt-12 md:pt-20 pb-16 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-4">
          ...
          {/* Right column - 40% */}
          <div className="w-full lg:w-[40%] flex justify-center lg:justify-end animate-fade-up animation-delay-300">
            <img
              src={bottleHero}
              alt="BoostUp Pure Shot - prémiový energetický shot"
              className="w-[320px] sm:w-[380px] md:w-[450px] lg:w-[500px] xl:w-[560px] drop-shadow-2xl object-contain -scale-x-100"
              loading="eager"
