    ...
    <section id="3b" className="py-28 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          <span className="inline-flex items-center gap-2 px-5 py-2 bg-primary text-primary-foreground rounded-full text-sm font-bold tracking-wide animate-fade-up shadow-button" style={getTextStyle(SITE_CONTENT, 'concept3b.badge')}>
